...
public class ExamGenSpringMVCConfig {
	...
	public DataSource securityDataSource() {
		...
		securityDataSource.setJdbcUrl("jdbc:mysql://localhost:3306/examgendb1?useSSL=false");
		securityDataSource.setUser("examgen-owner");
		securityDataSource.setPassword("examgen-owner");
